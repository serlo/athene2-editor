...
define("quickdiff", ["jquery"], function(){});
...
define("searchcursor", ["codemirror"], function(){});
...
/*global define*/
define('content',['underscore'], function (_) {
...
/*global define*/
define('shortcuts',['jquery', 'underscore', 'common', 'events'], function ($, _, Common, eventScope) {
...
/*global define*/
define('spoiler',['jquery'], function ($) {
...
i18n.de = {
    ...
    "Edit %s" : "Bearbeite %s",
    "Uploading." : "Läd hoch.",
    "You only can upload one file" : "",
    "Not an accepted file type" : "",
    "Filesize is too big" : "",
    "An error occured: %s" : "",
    "Image successfully uploaded." : "",
    "An error occured." : "",
    "Geogebra plugin could not be loaded, please try again." : "",
    "Loading reference data" : "",
    "Normal" : "",
    "Geogebra" : "",
    "Pick a reference type:" : "Wähle einen Referenz-Typ:",
    "Title" : "Titel"
};
...
/*global define*/
define('formfield',['jquery', 'underscore', 'layout_builder', 'system_notification', 'events'], function ($, _, LayoutBuilder, SystemNotification, eventScope) {
...
/*global define*/
define('preview',['formfield', 'events', 'jquery'], function (Field, eventScope, $) {
...
/*global define*/
define('texteditor_helper',['jquery', 'common', 'events', 'translator'], function ($, Common, eventScope, t) {
...
/*global define*/
define('texteditor_plugin_manager',['underscore', 'events'], function (_, eventScope) {
...
define('text!editor/templates/plugins/default.html',[],function () { return '<div class="editor-plugin">\n    <div class="panel panel-default">\n        <div class="panel-heading">{{ title }}</div>\n        <div class="panel-body">\n            <input type="text" value="{{ content }}" />\n        </div>\n    </div>\n</div>';});

/*global define*/
define('texteditor_plugin',['jquery', 'events', 'translator', 'text!./editor/templates/plugins/default.html'], function ($, eventScope, t, plugin_template) {
    var EditorPlugin,
        defaults = {};
...
(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        // Register as an anonymous AMD module:
        define('fileupload_iframetransport',['jquery'], factory);
    } else {
        // Browser globals:
        factory(window.jQuery);
    }
...
/*global define*/
define('texteditor_plugin_image',[
    'jquery',
    'underscore',
    'common',
    'system_notification',
...
define('text!editor/templates/plugins/wiris/wiris_plugin.html',[],function () { return '<div class="editor-plugin panel panel-default">\n    <div class="panel-heading">{{ name }}</div>\n    <div class="panel-body content">\n        \n    </div>\n    <div class="panel-footer"><a href="#" class="btn btn-cancel">Cancel</a><a href="#" class="btn btn-success btn-save pull-right">Save</a></div>\n</div>';});

/*global define, require, MathJax*/
define(
    'texteditor_plugin_wiris',['jquery',
    'underscore',
...
define('text!editor/templates/plugins/injection/injection_plugin.html',[],function () { return '<div class="editor-plugin panel panel-default">\n    <div class="panel-heading">{{ name }}</div>\n    <div class="panel-body">\n        <div class="alert alert-info">Loading injection data</div>\n    </div>\n    <div class="panel-footer"><a href="#" class="btn btn-cancel btn-default">Cancel</a></div>\n</div>';});
...
/*global define*/
define('texteditor_plugin_injection',[
    'jquery',
    'underscore',
    'common',
    'system_notification',
...
define('text!editor/templates/plugins/injection/injection_plugin_default.html',[],function () { return '<div class="editor-plugin panel panel-default">\n    <div class="panel-heading">{{ name }}</div>\n    <div class="panel-body">\n        <div class="form-group">\n            <input class="title form-control" type="text" value="{{ title }}" />\n            <input class="href form-control" type="text" value="{{ href }}" />\n        </div>\n    </div>\n    <div class="panel-footer"><a href="#" class="btn btn-cancel">Cancel</a><a href="#" class="btn btn-success btn-save pull-right">Save</a></div>\n</div>';});

/*global define*/
define('texteditor_plugin_default_injection',[
    'jquery',
    'underscore',
    'common',
    'system_notification',
...
define('text!editor/templates/plugins/injection/injection_plugin_geogebra.html',[],function () { return '<div class="editor-plugin panel panel-default">\n    <div class="panel-heading">{{ name }}</div>\n    <div class="panel-body">\n        <div class="form-group">\n            <input class="title form-control" type="text" value="{{ title }}" />\n            <input class="href form-control" type="text" value="{{ href }}" />\n            <article class="geogebraweb" data-param-width="500" data-param-height="500" data-param-showMenuBar="true" data-param-showtoolbar="true" data-param-usebrowserforjs="true" data-param-enableRightClick="true"></article>\n\n            <div class="is-hidden">\n                <form id="fileupload">\n                    <input type="file" name="file">\n                </form>\n            </div>\n        </div>\n    </div>\n    <div class="panel-footer"><a href="#" class="btn btn-cancel">Cancel</a><div class="pull-right btn-group"><a href="#" class="btn btn-success btn-save save-as-image">Insert as image</a><a href="#" class="btn btn-success btn-save">Insert as Applet</a></div></div>\n</div>';});
...
define('texteditor_plugin_geogebra_injection',[
    'jquery',
    'underscore',
    'common',
    'system_notification',
